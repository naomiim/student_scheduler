...
class Course:
    def __init__(self, start_time: time, end_time: time, subject: str, course_number: int, num_of_credits: int, professor: str, seats_remaining: int, location: str, description: str):
